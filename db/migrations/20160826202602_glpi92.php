...
class Glpi92 extends AbstractMigration {
   ...
   public function change() {
      ...
      $authldap->addColumn('name', 'string', array('null' => true))
               ->addColumn('host', 'string', array('null' => true))
               ->addColumn('basedn', 'string', array('null' => true))
               ->addColumn('rootdn', 'string', array('null' => true))
               ->addColumn('port', 'integer', array('default' => 389))
               ->addColumn('condition', 'text', array('default' => ''))
               ->addColumn('login_field', 'string', array('default' => 'uid'))
               ->addColumn('use_tls', 'boolean', array('default' => false))
               ->addColumn('group_field', 'string', array('null' => true))
               ->addColumn('group_condition', 'text', array('default' => ''))
               ->addColumn('group_search_type', 'integer', array('default' => 0))
               ->addColumn('group_member_field', 'string', array('null' => true))
               ->addColumn('email1_field', 'string', array('null' => true))
               ->addColumn('realname_field', 'string', array('null' => true))
               ->addColumn('firstname_field', 'string', array('null' => true))
               ->addColumn('phone_field', 'string', array('null' => true))
               ->addColumn('phone2_field', 'string', array('null' => true))
               ->addColumn('mobile_field', 'string', array('null' => true))
               ->addColumn('comment_field', 'string', array('null' => true))
               ...
               ->addColumn('title_field', 'string', array('null' => true))
               ->addColumn('category_field', 'string', array('null' => true))
               ->addColumn('language_field', 'string', array('null' => true))
               ->addColumn('entity_field', 'string', array('null' => true))
               ->addColumn('entity_condition', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('is_default', 'boolean', array('default' => false))
               ->addColumn('is_active', 'boolean', array('default' => false))
               ->addColumn('rootdn_passwd', 'string', array('null' => true))
               ->addColumn('registration_number_field', 'string', array('null' => true))
               ->addColumn('email2_field', 'string', array('null' => true))
               ->addColumn('email3_field', 'string', array('null' => true))
               ->addColumn('email4_field', 'string', array('null' => true))
               ->addColumn('location_field', 'string', array('null' => true))
               ...
               ->addColumn('picture_field', 'string', array('null' => true))
      ...
      $authmail->addColumn('name', 'string', array('null' => true))
               ->addColumn('connect_string', 'string', array('null' => true))
               ->addColumn('host', 'string', array('null' => true))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('is_active', 'boolean', array('default' => false))
      ...
      $autoupdatesystem->addColumn('name', 'string', array('null' => true))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addIndex(array('name'))
                       ->create();
      ...
      $blacklistedmailcontent->addColumn('name', 'string', array('null' => true))
                             ->addColumn('content', 'text', array('default' => ''))
                             ->addColumn('comment', 'text', array('default' => ''))
                             ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                             ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                             ->addIndex(array('date_mod'))
      ...
      $budgettype->addColumn('name', 'string', array('null' => true))
                 ->addColumn('comment', 'text', array('default' => ''))
                 ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                 ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                 ->addIndex(array('name'))
      ...
      $cartridgeitem->addColumn('name', 'string', array('null' => true))
                    ->addColumn('comment', 'text', array('default' => ''))
                    ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                    ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                    ->addIndex(array('name'))
      ...
      $computermodel->addColumn('name', 'string', array('null' => true))
                    ->addColumn('comment', 'text', array('default' => ''))
                    ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                    ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                    ->addIndex(array('name'))
      ...
      $computertype->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('name'))
      ...
      $config->addColumn('context', 'string', array('limit' => 150))
             ...
             ->addColumn('value', 'text', array('default' => ''))
      ...
      $consumableitemtype->addColumn('name', 'string', array('null' => true))
                         ->addColumn('comment', 'text', array('default' => ''))
                         ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                         ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                         ->addIndex(array('name'))
      ...
      $contacttype->addColumn('name', 'string', array('null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addIndex(array('name'))
      ...
      $contracttype->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('name'))
      ...
      $devicecasetype->addColumn('name', 'string', array('null' => true))
                     ->addColumn('comment', 'text', array('default' => ''))
                     ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                     ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                     ->addIndex(array('name'))
      ...
      $devicememorytype->addColumn('name', 'string', array('default' => ''))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                       ->addIndex(array('name'))
      ...
      $documentcategory->addColumn('name', 'string', array('null' => true))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addColumn('documentcategory_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('completename', 'text', array('default' => ''))
                       ->addColumn('level', 'integer', array('default' => 0))
                       ->addColumn('ancestors_cache', 'text', array('default' => ''))
                       ->addColumn('sons_cache', 'text', array('default' => ''))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
      ...
      $documenttype->addColumn('name', 'string')
                   ...
                   ->addColumn('icon', 'string', array('null' => true, 'default' => true))
      ...
      $dropdowntranslation->addColumn('items_id', 'integer', array('default' => 0))
      ...
      $event->addColumn('items_id', 'integer', array('default' => 0))
            ->addColumn('type', 'string', array('null' => true))
            ->addColumn('date', 'datetime')
            ->addColumn('service', 'string', array('null' => true))
            ->addColumn('level', 'integer', array('default' => 0))
            ->addColumn('message', 'text', array('default' => ''))
            ->addIndex(array('date'))
      ...
      $log->addColumn('itemtype', 'string', array('limit' => 100, 'default' => ''))
          ->addColumn('items_id', 'integer', array('default' => 0))
          ...
          ->addColumn('user_name', 'string', array('null' => true))
          ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $mailcollector->addColumn('name', 'string', array('null' => true))
                    ->addColumn('host', 'string', array('null' => true))
      ...
      $manufacturer->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('name'))
      ...
      $monitormodel->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('name'))
      ...
      $monitortype->addColumn('name', 'string', array('null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addIndex(array('name'))
      ...
      $networkequipmentfirmware->addColumn('name', 'string', array('null' => true))
                               ->addColumn('comment', 'text', array('default' => ''))
                               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                               ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                               ->addIndex(array('name'))
      ...
      $networkequipmentmodel->addColumn('name', 'string', array('null' => true))
                            ->addColumn('comment', 'text', array('default' => ''))
                            ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                            ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                            ->addIndex(array('name'))
      ...
      $networkequipmenttype->addColumn('name', 'string', array('null' => true))
                           ->addColumn('comment', 'text', array('default' => ''))
                           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                           ->addIndex(array('name'))
      ...
      $networkinterface->addColumn('name', 'string', array('null' => true))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                       ->addIndex(array('name'))
      ...
      $network->addColumn('name', 'string', array('null' => true))
              ->addColumn('comment', 'text', array('default' => ''))
              ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
              ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
              ->addIndex(array('name'))
      ...
      $notificationtemplate->addColumn('name', 'string')
                           ...
                           ->addColumn('css', 'text', array('default' => ''))
                           ->addColumn('comment', 'text', array('default' => ''))
                           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                           ->addIndex(array('name'))
      ...
      $notificationtemplatetranslation->addColumn('notificationtemplate_id', 'integer', array('default' => null, 'null' => true))
                                      ->addColumn('language', 'string', array('limit' => 5, 'default' => ''))
                                      ->addColumn('subject', 'string')
                                      ->addColumn('content_text', 'text', array('default' => ''))
                                      ->addColumn('content_html', 'text', array('default' => ''))
      ...
      $operatingsystemarchitecture->addColumn('name', 'string', array('null' => true))
                                  ->addColumn('comment', 'text', array('default' => ''))
                                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                                  ->addIndex(array('name'))
      ...
      $operatingsystem->addColumn('name', 'string', array('null' => true))
                      ->addColumn('comment', 'text', array('default' => ''))
                      ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                      ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                      ->addIndex(array('name'))
      ...
      $operatingsystemservicepack->addColumn('name', 'string', array('null' => true))
                                 ->addColumn('comment', 'text', array('default' => ''))
                                 ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                                 ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                                 ->addIndex(array('name'))
      ...
      $operatingsystemversion->addColumn('name', 'string', array('null' => true))
                             ->addColumn('comment', 'text', array('default' => ''))
                             ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                             ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                             ->addIndex(array('name'))
      ...
      $peripheralmodel->addColumn('name', 'string', array('null' => true))
                      ->addColumn('comment', 'text', array('default' => ''))
                      ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                      ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                      ->addIndex(array('name'))
      ...
      $peripheraltype->addColumn('name', 'string', array('null' => true))
                     ->addColumn('comment', 'text', array('default' => ''))
                     ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                     ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                     ->addIndex(array('name'))
      ...
      $phonemodel->addColumn('name', 'string', array('null' => true))
                 ->addColumn('comment', 'text', array('default' => ''))
                 ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                 ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                 ->addIndex(array('name'))
      ...
      $phonepowersupply->addColumn('name', 'string', array('null' => true))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                       ->addIndex(array('name'))
      ...
      $phonetype->addColumn('name', 'string', array('null' => true))
                ->addColumn('comment', 'text', array('default' => ''))
                ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                ->addIndex(array('name'))
      ...
      $plugin->addColumn('directory', 'string')
             ...
             ->addColumn('author', 'string', array('null' => true))
             ->addColumn('homepage', 'string', array('null' => true))
             ->addColumn('license', 'string', array('null' => true))
      ...
      $printermodel->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('name'))
      ...
      $printertype->addColumn('name', 'string', array('null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addIndex(array('name'))
      ...
      $cartridgeitemtype->addColumn('name', 'string', array('null' => true))
                        ->addColumn('comment', 'text', array('default' => ''))
                        ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                        ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                        ->addIndex(array('name'))
      ...
      $projecttasktype->addColumn('name', 'string', array('null' => true))
                      ->addColumn('comment', 'text', array('default' => ''))
                      ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                      ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                      ->addIndex(array('name'))
      ...
      $projecttype->addColumn('name', 'string', array('null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addIndex(array('name'))
      ...
      $registeredid->addColumn('name', 'string', array('null' => true))
                   ->addColumn('items_id', 'integer', array('default' => 0))
                   ->addColumn('itemtype', 'string', array('limit' => 100))
      ...
      $softwarecategorie->addColumn('name', 'string', array('null' => true))
                        ->addColumn('comment', 'text', array('default' => ''))
      ...
      $softwarelicensetype->addColumn('name', 'string', array('null' => true))
                          ->addColumn('comment', 'text', array('default' => ''))
                          ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                          ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                          ->addIndex(array('name'))
      ...
      $ssovariable->addColumn('name', 'string', array('null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addIndex(array('date_mod'))
      ...
      $suppliertype->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('date_mod'))
      ...
      $usercategory->addColumn('name', 'string', array('null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addIndex(array('date_mod'))
      ...
      $usertitle->addColumn('name', 'string', array('null' => true))
                ->addColumn('comment', 'text', array('default' => ''))
                ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                ->addIndex(array('date_mod'))
      ...
      $virtualmachinestate->addColumn('name', 'string', array('null' => true))
                          ->addColumn('comment', 'text', array('default' => ''))
                          ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                          ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                          ->addIndex(array('date_mod'))
      ...
      $virtualmachinesystem->addColumn('name', 'string', array('null' => true))
                           ->addColumn('comment', 'text', array('default' => ''))
                           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                           ->addIndex(array('date_mod'))
      ...
      $virtualmachinetype->addColumn('name', 'string', array('null' => true))
                         ->addColumn('comment', 'text', array('default' => ''))
                         ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                         ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                         ->addIndex(array('date_mod'))
      ...
      $entity->addColumn('name', 'string', array('null' => true))
             ...
             ->addColumn('ancestors_cache', 'text', array('default' => ''))
             ->addColumn('sons_cache', 'text', array('default' => ''))
             ->addColumn('address', 'text', array('default' => ''))
             ->addColumn('postcode', 'string', array('null' => true))
             ->addColumn('town', 'string', array('null' => true))
             ...
             ->addColumn('fax', 'string', array('null' => true))
             ->addColumn('email', 'string', array('null' => true))
             ->addColumn('admin_email', 'string', array('null' => true))
             ->addColumn('admin_email_name', 'string', array('null' => true))
             ->addColumn('admin_reply', 'string', array('null' => true))
             ->addColumn('admin_reply_name', 'string', array('null' => true))
             ->addColumn('notification_subject_tag', 'string', array('null' => true))
             ->addColumn('ldap_dn', 'string', array('null' => true))
             ->addColumn('tag', 'string', array('null' => true))
             ->addColumn('authldap_id', 'integer', array('default' => null, 'null' => true))
             ->addColumn('mail_domain', 'string', array('null' => true))
             ->addColumn('entity_ldapfilter', 'text', array('default' => ''))
             ->addColumn('mailing_signature', 'text', array('default' => ''))
      ...
      $apiclient->addColumn('name', 'string', array('default' => ''))
      ...
      $calendar->addColumn('name', 'string', array('default' => ''))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('cache_duration', 'text', array('default' => ''))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $calendarsegment->addColumn('calendar_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $cartridgeitem_printermodel->addColumn('cartridgeitem_id', 'integer', array('default' => null, 'null' => true))
      ...
      $contact->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
              ->addColumn('name', 'string', array('null' => true))
              ->addColumn('firstname', 'string', array('null' => true))
              ->addColumn('phone', 'string', array('null' => true))
              ->addColumn('phone2', 'string', array('null' => true))
              ->addColumn('mobile', 'string', array('null' => true))
              ->addColumn('fax', 'string', array('null' => true))
              ->addColumn('email', 'string', array('null' => true))
      ...
      $contract->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('name', 'string', array('null' => true))
               ->addColumn('num', 'string', array('null' => true))
               ...
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('accounting_number', 'string', array('null' => true))
               ->addColumn('is_deleted', 'boolean', array('default' => false))
               ...
               ->addColumn('template_name', 'string', array('null' => true))
      ...
      $contract_item->addColumn('contract_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('items_id', 'integer', array('default' => 0))
                    ->addColumn('itemtype', 'string', array('limit' => 100))
                    ->addForeignKey('contract_id', 'glpi_contract', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $crontasklog->addColumn('crontask_id', 'integer', array('default' => null, 'null' => true))
                  ...
                  ->addForeignKey('crontask_id', 'glpi_crontask', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $domain->addColumn('name', 'string', array('null' => true))
             ->addColumn('entity_id', 'integer')
             ->addColumn('is_recursive', 'boolean', array('default' => false))
             ->addColumn('comment', 'text', array('default' => ''))
             ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $fieldblacklist->addColumn('name', 'string', array('null' => true, 'default' => ''))
                     ->addColumn('field', 'string', array('null' => true, 'default' => ''))
                     ->addColumn('value', 'string', array('null' => true, 'default' => ''))
      ...
      $fieldunicity->addColumn('name', 'string', array('default' => ''))
                   ->addColumn('itemtype', 'string', array('limit' => 100, 'default' => ''))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('fields', 'text', array('default' => ''))
                   ->addColumn('is_active', 'boolean', array('default' => false))
      ...
      $fqdn->addColumn('name', 'string', array('null' => true))
           ->addColumn('entity_id', 'integer')
           ->addColumn('is_recursive', 'boolean', array('default' => false))
           ->addColumn('fqdn', 'string', array('null' => true))
           ->addColumn('comment', 'text', array('default' => ''))
           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
           ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $group->addColumn('name', 'string', array('null' => true))
            ->addColumn('entity_id', 'integer')
            ->addColumn('is_recursive', 'boolean', array('default' => false))
            ->addColumn('ldap_field', 'string', array('null' => true))
            ->addColumn('ldap_value', 'text', array('default' => ''))
            ->addColumn('ldap_group_dn', 'text', array('default' => ''))
      ...
      $holiday->addColumn('name', 'string', array('null' => true))
              ->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $ipaddress->addColumn('name', 'string', array('null' => true))
                ->addColumn('entity_id', 'integer')
                ->addColumn('items_id', 'integer', array('default' => 0))
                ->addColumn('itemtype', 'string', array('limit' => 100))
      ...
      $ipnetwork->addColumn('name', 'string', array('null' => true))
                ->addColumn('entity_id', 'integer')
                ->addColumn('is_recursive', 'boolean', array('default' => false))
                ->addColumn('completename', 'text', array('default' => ''))
                ...
                ->addColumn('version', 'integer', array('limit' => 3, 'default' => 0))
                ->addColumn('address', 'string', array('limit' => 40, 'null' => true))
                ...
                ->addColumn('netmask', 'string', array('limit' => 40, 'null' => true))
                ...
                ->addColumn('gateway', 'string', array('limit' => 40, 'null' => true))
      ...
      $knowbaseitemcategory->addColumn('name', 'string', array('null' => true))
                           ->addColumn('entity_id', 'integer')
                           ->addColumn('is_recursive', 'boolean', array('default' => false))
                           ->addColumn('completename', 'text', array('default' => ''))
      ...
      $link->addColumn('name', 'string', array('null' => true))
           ->addColumn('entity_id', 'integer')
           ->addColumn('is_recursive', 'boolean', array('default' => false))
           ->addColumn('link', 'string', array('null' => true))
           ->addColumn('data', 'text', array('default' => ''))
      ...
      $link_itemtype->addColumn('link_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('itemtype', 'string', array('limit' => 100))
                    ->addForeignKey('link_id', 'glpi_link', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $location->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('completename', 'text', array('default' => ''))
               ...
               ->addColumn('ancestors_cache', 'text', array('default' => ''))
               ->addColumn('sons_cache', 'text', array('default' => ''))
               ->addColumn('building', 'string', array('null' => true))
               ->addColumn('room', 'string', array('null' => true))
               ->addColumn('latitude', 'string', array('null' => true))
               ->addColumn('longitude', 'string', array('null' => true))
               ->addColumn('altitude', 'string', array('null' => true))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $netpoint->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $networkname->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('items_id', 'integer', array('default' => 0))
                  ->addColumn('itemtype', 'string', array('limit' => 100))
      ...
      $networkport->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('items_id', 'integer', array('default' => 0))
                  ->addColumn('itemtype', 'string', array('limit' => 100))
                  ->addColumn('logical_number', 'integer', array('default' => 0))
                  ->addColumn('instantiation_type', 'string', array('null' => true))
                  ->addColumn('mac', 'string', array('null' => true))
                  ->addColumn('is_deleted', 'boolean', array('default' => false))
                  ->addColumn('is_dynamic', 'boolean', array('default' => false))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $networkportaggregate->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('networkports_id_list', 'text', array('comment' => 'array of associated networkports_id'))
                           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                           ->addForeignKey('networkport_id', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $networkportalias->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
      ...
      $networkportdialup->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                        ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                        ->addForeignKey('networkport_id', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addIndex(array('networkport_id'), array('unique' => true))
      ...
      $networkportlocal->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                       ->addForeignKey('networkport_id', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addIndex(array('networkport_id'), array('unique' => true))
      ...
      $networkport_networkport->addColumn('networkport_id_1', 'integer', array('default' => null, 'null' => true))
                              ->addColumn('networkport_id_2', 'integer', array('default' => null, 'null' => true))
                              ->addForeignKey('networkport_id_1', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                              ->addForeignKey('networkport_id_2', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $notificationtarget->addColumn('items_id', 'integer')
                         ...
                         ->addForeignKey('notification_id', 'glpi_notification', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                         ->addIndex(array('type', 'items_id'))
      ...
      $rule->addColumn('name', 'string')
           ...
           ->addColumn('description', 'text', array('default' => ''))
      ...
      $sla->addColumn('name', 'string', array('null' => true))
          ->addColumn('entity_id', 'integer')
          ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $slt->addColumn('name', 'string', array('null' => true))
          ->addColumn('entity_id', 'integer')
          ->addColumn('is_recursive', 'boolean', array('default' => false))
          ->addColumn('type', 'integer', array('default' => 0))
          ->addColumn('number_time', 'integer')
          ->addColumn('definition_time', 'string', array('null' => true))
      ...
      $solutiontype->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $solutiontemplate->addColumn('name', 'string', array('null' => true))
                       ->addColumn('entity_id', 'integer')
                       ->addColumn('is_recursive', 'boolean', array('default' => false))
                       ->addColumn('content', 'text', array('default' => ''))
      ...
      $state->addColumn('name', 'string', array('null' => true))
            ->addColumn('entity_id', 'integer')
            ->addColumn('is_recursive', 'boolean', array('default' => false))
            ->addColumn('completename', 'text', array('default' => ''))
      ...
      $supplier->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $taskcategory->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('completename', 'text', array('default' => ''))
      ...
      $tasktemplate->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('content', 'text', array('default' => ''))
                   ->addColumn('taskcategory_id', 'integer', array('default' => null, 'null' => true))
      ...
      $tickettemplate->addColumn('name', 'string', array('null' => true))
                     ->addColumn('entity_id', 'integer')
                     ->addColumn('is_recursive', 'boolean', array('default' => false))
                     ->addColumn('comment', 'text', array('default' => ''))
                     ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $tickettemplatehiddenfield->addColumn('tickettemplate_id', 'integer', array('default' => null, 'null' => true))
      ...
      $tickettemplatemandatoryfield->addColumn('tickettemplate_id', 'integer', array('default' => null, 'null' => true))
                                   ->addColumn('num', 'integer', array('default' => 0))
                                   ->addForeignKey('tickettemplate_id', 'glpi_tickettemplate', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                                   ->addIndex(array('tickettemplate_id', 'num'), array('unique' => true))
                                   ->create();
      ...
      $tickettemplatepredefinedfield->addColumn('tickettemplate_id', 'integer', array('default' => null, 'null' => true))
                                    ->addColumn('num', 'integer', array('default' => 0))
                                    ->addColumn('value', 'text', array('default' => ''))
                                    ->addForeignKey('tickettemplate_id', 'glpi_tickettemplate', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                                    ->addIndex(array('tickettemplate_id', 'num'), array('unique' => true))
      ...
      $transfer->addColumn('name', 'string', array('null' => true))
      ...
      $user->addColumn('name', 'string', array('null' => true))
           ->addColumn('password', 'string', array('null' => true))
           ->addColumn('phone', 'string', array('null' => true))
           ->addColumn('phone2', 'string', array('null' => true))
           ->addColumn('mobile', 'string', array('null' => true))
           ->addColumn('realname', 'string', array('null' => true))
           ->addColumn('firstname', 'string', array('null' => true))
           ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
           ...
           ->addColumn('list_limit', 'integer', array('null' => true))
           ->addColumn('is_active', 'boolean', array('default' => true))
           ...
           ->addColumn('csv_delimiter', 'char', array('limit' => 1, 'null' => true))
           ...
           ->addColumn('user_dn', 'text', array('default' => ''))
           ->addColumn('registration_number', 'string', array('null' => true))
           ->addColumn('show_count_on_tabs', 'boolean', array('default' => null, 'null' => true))
           ...
           ->addColumn('display_options', 'text', array('default' => ''))
           ...
           ->addColumn('privatebookmarkorder', 'text', array('default' => ''))
           ...
           ->addColumn('plannings', 'text', array('default' => null, 'null' => true))
           ->addColumn('comment', 'text', array('default' => ''))
           ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
           ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
           ->addForeignKey('location_id', 'glpi_location', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $profile->addColumn('name', 'string')
              ...
              ->addColumn('helpdesk_item_type', 'text', array('default' => ''))
              ...
              ->addColumn('change_status', 'text', array('default' => '', 'comment' => 'json encoded array of from/dest allowed status change'))
              ->addColumn('comment', 'text', array('default' => ''))
              ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
              ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
              ->addForeignKey('tickettemplate_id', 'glpi_tickettemplate', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $useremail->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                ->addColumn('is_default', 'boolean', array('default' => false))
                ->addColumn('is_dynamic', 'boolean', array('default' => false))
      ...
      $vlan->addColumn('name', 'string', array('null' => true))
           ->addColumn('entity_id', 'integer')
           ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $wifinetwork->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('essid', 'string', array('null' => true, 'default' => null))
                  ->addColumn('mode', 'string', array('null' => true, 'default' => null, 'comment' => 'ad-hoc, access_point'))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                  ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                  ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $bookmark->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ...
               ->addColumn('path', 'string', array('null' => true, 'default' => null))
               ->addColumn('query', 'text', array('default' => ''))
               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
               ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
               ->addIndex(array('type'))
               ->addIndex(array('itemtype'))
      ...
      $bookmark_user->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('itemtype', 'string', array('limit' => 100))
                    ->addColumn('bookmark_id', 'integer', array('default' => null, 'null' => true))
                    ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('bookmark_id', 'glpi_bookmark', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $budget->addColumn('name', 'string', array('null' => true))
             ->addColumn('entity_id', 'integer')
             ->addColumn('is_recursive', 'boolean', array('default' => false))
             ->addColumn('is_deleted', 'boolean', array('default' => false))
             ...
             ->addColumn('is_template', 'boolean', array('default' => false))
             ->addColumn('template_name', 'string', array('null' => true, 'default' => null))
             ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
      ...
      $calendar_holiday->addColumn('calendar_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('holiday_id', 'integer', array('default' => null, 'null' => true))
                       ->addForeignKey('calendar_id', 'glpi_calendar', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addForeignKey('holiday_id', 'glpi_holiday', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $computer->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('serial', 'string', array('null' => true))
               ->addColumn('otherserial', 'string', array('null' => true))
               ->addColumn('contact', 'string', array('null' => true))
               ->addColumn('contact_num', 'string', array('null' => true))
               ...
               ->addColumn('os_license_number', 'string', array('null' => true, 'default' => null))
               ->addColumn('os_licenseid', 'string', array('null' => true, 'default' => null))
               ->addColumn('os_kernel_version', 'string', array('null' => true, 'default' => null))
               ...
               ->addColumn('uuid', 'string', array('null' => true, 'default' => null))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $computerantivirus->addColumn('name', 'string', array('null' => true))
                        ->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('antivirus_version', 'string', array('null' => true, 'default' => null))
                        ->addColumn('signature_version', 'string', array('null' => true, 'default' => null))
                        ->addColumn('is_active', 'boolean', array('default' => false))
                        ->addColumn('is_deleted', 'boolean', array('default' => false))
                        ...
                        ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                        ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                        ->addForeignKey('computer_id', 'glpi_computer', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addForeignKey('manufacturer_id', 'glpi_manufacturer', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addIndex(array('name'))
      ...
      $computerdisk->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('device', 'string', array('null' => true, 'default' => null))
                   ->addColumn('mountpoint', 'string', array('null' => true, 'default' => null))
      ...
      $computer_item->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('items_id', 'integer', array('default' => 0))
                    ->addColumn('itemtype', 'string', array('limit' => 100))
                    ->addColumn('is_deleted', 'boolean', array('default' => false))
                    ->addColumn('is_dynamic', 'boolean', array('default' => false))
      ...
      $computervirtualmachine->addColumn('name', 'string', array('null' => true))
                             ->addColumn('entity_id', 'integer')
                             ->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
      ...
      $consumableitem->addColumn('name', 'string', array('null' => true))
                     ->addColumn('entity_id', 'integer')
                     ->addColumn('is_recursive', 'boolean', array('default' => false))
                     ->addColumn('ref', 'string', array('null' => true, 'default' => null))
                     ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
      ...
      $contact_supplier->addColumn('supplier_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('contact_id', 'integer', array('default' => null, 'null' => true))
                       ->addForeignKey('supplier_id', 'glpi_supplier', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addForeignKey('contact_id', 'glpi_contact', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $contractcost->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('contract_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('begin_date', 'date', array('null' => true, 'default' => null))
                   ->addColumn('end_date', 'date', array('null' => true, 'default' => null))
      ...
      $contract_supplier->addColumn('supplier_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('contract_id', 'integer', array('default' => null, 'null' => true))
                        ->addForeignKey('supplier_id', 'glpi_supplier', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addForeignKey('contract_id', 'glpi_contract', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $devicecase->addColumn('designation', 'string', array('null' => true))
                 ->addColumn('entity_id', 'integer')
                 ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $devicecontrol->addColumn('designation', 'string', array('null' => true))
                    ->addColumn('entity_id', 'integer')
                    ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $devicedrive->addColumn('designation', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('is_writer', 'boolean', array('default' => false))
                  ->addColumn('speed', 'string', array('null' => true))
                  ->addColumn('interfacetype_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $devicegraphiccard->addColumn('designation', 'string', array('null' => true))
                        ->addColumn('entity_id', 'integer')
                        ->addColumn('is_recursive', 'boolean', array('default' => false))
                        ->addColumn('memory_default', 'integer', array('default' => 0))
                        ->addColumn('chipset', 'string', array('null' => true))
                        ->addColumn('interfacetype_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('comment', 'text', array('default' => ''))
                        ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
      ...
      $deviceharddrive->addColumn('designation', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addColumn('rpm', 'string', array('null' => true))
                      ->addColumn('cache', 'string', array('null' => true))
      ...
      $devicememory->addColumn('designation', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('frequence', 'string', array('null' => true))
      ...
      $devicemotherboard->addColumn('designation', 'string', array('null' => true))
                        ->addColumn('entity_id', 'integer')
                        ->addColumn('is_recursive', 'boolean', array('default' => false))
                        ->addColumn('chipset', 'string', array('null' => true))
                        ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
      ...
      $devicenetworkcard->addColumn('designation', 'string', array('null' => true))
                        ->addColumn('entity_id', 'integer')
                        ->addColumn('is_recursive', 'boolean', array('default' => false))
                        ->addColumn('bandwidth', 'string', array('null' => true))
                        ->addColumn('mac_default', 'string', array('null' => true))
                        ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('comment', 'text', array('default' => ''))
                        ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                        ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
      ...
      $devicepci->addColumn('designation', 'string', array('null' => true))
                ->addColumn('entity_id', 'integer')
                ->addColumn('is_recursive', 'boolean', array('default' => false))
                ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
                ->addColumn('comment', 'text', array('default' => ''))
      ...
      $devicepowersupply->addColumn('designation', 'string', array('null' => true))
                        ->addColumn('entity_id', 'integer')
                        ->addColumn('is_recursive', 'boolean', array('default' => false))
                        ->addColumn('power', 'string', array('null' => true))
      ...
      $deviceprocessor->addColumn('designation', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
      ...
      $devicesoundcard->addColumn('designation', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addColumn('type', 'string', array('null' => true))
                      ->addColumn('manufacturer_id', 'integer', array('default' => null, 'null' => true))
      ...
      $reminder->addColumn('name', 'string', array('null' => true))
               ->addColumn('date', 'datetime')
               ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('text', 'text', array('default' => ''))
      ...
      $entity_reminder->addColumn('reminder_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addForeignKey('reminder_id', 'glpi_reminder', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                      ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $group_reminder->addColumn('reminder_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('entity_id', 'integer')
                     ->addColumn('is_recursive', 'boolean', array('default' => false))
                     ->addForeignKey('reminder_id', 'glpi_reminder', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $reminder_user->addColumn('reminder_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                    ->addForeignKey('reminder_id', 'glpi_reminder', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addIndex(array('reminder_id'))
      ...
      $reservation->addColumn('reservationitem_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('begin_date', 'datetime')
                  ->addColumn('end_date', 'datetime')
                  ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('comment', 'text', array('default' => ''))
                  ->addColumn('group', 'integer', array('default' => 0))
                  ->addForeignKey('reservationitem_id', 'glpi_reservationitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                  ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                  ->addIndex(array('begin_date'))
                  ->addIndex(array('end_date'))
      ...
      $rssfeed->addColumn('name', 'string', array('null' => true))
              ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('url', 'text', array('default' => ''))
      ...
      $rssfeed_user->addColumn('rssfeed_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                   ->addForeignKey('rssfeed_id', 'glpi_rssfeed', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $slalevel->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('calendar_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('comment', 'text', array('default' => ''))
      ...
      $slalevelaction->addColumn('slalevel_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('action_type', 'string', array('null' => true, 'default' => true))
                     ->addColumn('field', 'string', array('null' => true, 'default' => true))
                     ->addColumn('value', 'string', array('null' => true, 'default' => true))
                     ->addForeignKey('slalevel_id', 'glpi_slalevel', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addIndex(array('slalevel_id'))
                     ->create();

      // create the table glpi_slalevelcriteria
      $slalevelcriteria = $this->table('glpi_slalevelcriteria');
      $slalevelcriteria->addColumn('slalevel_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('criteria', 'string', array('null' => true, 'default' => true))
                       ->addColumn('condition', 'integer', array('default' => 0, 'comment' => 'see define.php PATTERN_* and REGEX_* constant'))
                       ->addColumn('pattern', 'string', array('null' => true, 'default' => true))
                       ->addForeignKey('slalevel_id', 'glpi_slalevel', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addIndex(array('slalevel_id'))
                       ->addIndex(array('condition'))
                       ->create();
      ...
      $software->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('user_id_tech', 'integer', array('default' => null, 'null' => true))
      ...
      $softwareversion->addColumn('name', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addColumn('software_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('state_id', 'integer', array('default' => null, 'null' => true))
      ...
      $softwarelicense->addColumn('name', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addColumn('software_id', 'integer', array('default' => null, 'null' => true))
      ...
      $queuedmail->addColumn('name', 'text', array('default' => ''))
                 ->addColumn('entity_id', 'integer')
                 ->addColumn('itemtype', 'string', array('limit' => 100))
                 ->addColumn('items_id', 'integer', array('default' => 0))
                 ->addColumn('notificationtemplate_id', 'integer', array('default' => null, 'null' => true))
                 ...
                 ->addColumn('sender', 'text', array('default' => ''))
                 ->addColumn('sendername', 'text', array('default' => ''))
                 ->addColumn('recipient', 'text', array('default' => ''))
                 ->addColumn('recipientname', 'text', array('default' => ''))
                 ->addColumn('replyto', 'text', array('default' => ''))
                 ->addColumn('replytoname', 'text', array('default' => ''))
                 ->addColumn('headers', 'text', array('default' => ''))
                 ->addColumn('body_html', 'text', array('default' => ''))
                 ->addColumn('body_text', 'text', array('default' => ''))
                 ->addColumn('messageid', 'text', array('default' => ''))
                 ->addColumn('documents', 'text', array('default' => ''))
                 ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                 ->addForeignKey('notificationtemplate_id', 'glpi_notificationtemplate', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $itilcategory->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('is_recursive', 'boolean', array('default' => false))
                   ->addColumn('completename', 'text', array('default' => ''))
      ...
      $ticket->addColumn('name', 'string', array('null' => true))
             ->addColumn('entity_id', 'integer')
             ->addColumn('date', 'datetime')
             ...
             ->addColumn('solutiontype_id', 'integer', array('default' => null, 'null' => true))
             ->addColumn('solution', 'text', array('default' => ''))
      ...
      $ticket_ticket->addColumn('ticket_id_1', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('ticket_id_2', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('link', 'integer', array('default' => 1))
                    ->addForeignKey('ticket_id_1', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('ticket_id_2', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $ticket_user->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('type', 'integer', array('default' => 1))
                  ->addColumn('use_notification', 'boolean', array('default' => true))
                  ->addColumn('alternative_email', 'string', array('null' => true, 'default' => null))
      ...
      $ticketsatisfaction->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                         ->addColumn('type', 'integer', array('default' => 1))
      ...
      $ticketrecurrent->addColumn('name', 'string', array('null' => true))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addColumn('is_active', 'boolean', array('default' => false))
                      ->addColumn('tickettemplate_id', 'integer', array('default' => null, 'null' => true))
                      ...
                      ->addColumn('periodicity', 'string', array('null' => true, 'default' => null))
      ...
      $ticketfollowup->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
      ...
      $tickettask->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('taskcategory_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('date', 'datetime', array('default' => null, 'null' => true))
                 ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('content', 'text', array('default' => ''))
      ...
      $ticketcost->addColumn('name', 'string', array('null' => true))
      ...
      $ticketvalidation->addColumn('entity_id', 'integer')
                       ...
                       ->addColumn('comment_submission', 'text', array('default' => ''))
                       ->addColumn('comment_validation', 'text', array('default' => ''))
      ...
      $supplier_ticket->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
      ...
      $slalevel_ticket->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('slalevel_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('date', 'datetime', array('default' => null, 'null' => true))
                      ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                      ->addForeignKey('slalevel_id', 'glpi_slalevel', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                      ->addIndex(array('ticket_id'))
      ...
      $project->addColumn('name', 'string', array('null' => true))
              ->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
              ->addColumn('code', 'string', array('null' => true, 'default' => null))
              ->addColumn('priority', 'integer', array('default' => 1))
      ...
      $projectcost->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('project_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('begin_date', 'date', array('default' => null, 'null' => true))
      ...
      $projecttask->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('content', 'text', array('default' => ''))
                  ->addColumn('project_id', 'integer', array('default' => null, 'null' => true))
      ...
      $profile_user->addColumn('user_id', 'integer')
                   ...
                   ->addColumn('is_dynamic', 'boolean', array('default' => false))
                   ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('profile_id', 'glpi_profile', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                   ->addIndex(array('entity_id'))
                   ->addIndex(array('profile_id'))
                   ->addIndex(array('user_id'))
      ...
      $printer->addColumn('name', 'string', array('null' => true))
              ->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
              ->addColumn('contact', 'string', array('null' => true, 'default' => null))
              ->addColumn('contact_num', 'string', array('null' => true, 'default' => null))
              ->addColumn('user_id_tech', 'integer', array('default' => null, 'null' => true))
              ->addColumn('group_id_tech', 'integer', array('default' => null, 'null' => true))
              ->addColumn('serial', 'string', array('null' => true, 'default' => null))
              ->addColumn('otherserial', 'string', array('null' => true, 'default' => null))
              ...
              ->addColumn('memory_size', 'string', array('null' => true, 'default' => null))
              ->addColumn('location_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('domain_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('network_id', 'integer', array('default' => null, 'null' => true))
      ...
      $phone->addColumn('name', 'string', array('null' => true))
            ->addColumn('entity_id', 'integer')
            ->addColumn('is_recursive', 'boolean', array('default' => false))
            ->addColumn('contact', 'string', array('null' => true, 'default' => null))
            ->addColumn('contact_num', 'string', array('null' => true, 'default' => null))
      ...
      $monitor->addColumn('name', 'string', array('null' => true))
              ->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
              ->addColumn('contact', 'string', array('null' => true, 'default' => null))
              ->addColumn('contact_num', 'string', array('null' => true, 'default' => null))
      ...
      $problem->addColumn('name', 'string', array('null' => true))
              ->addColumn('entity_id', 'integer')
              ->addColumn('is_recursive', 'boolean', array('default' => false))
              ->addColumn('is_deleted', 'boolean', array('default' => false))
              ->addColumn('status', 'integer', array('default' => 1))
              ...
              ->addColumn('priority', 'integer', array('default' => 1))
              ->addColumn('itilcategory_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('impactcontent', 'text', array('default' => ''))
              ->addColumn('causecontent', 'text', array('default' => ''))
              ->addColumn('symptomcontent', 'text', array('default' => ''))
              ->addColumn('solutiontype_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('solution', 'text', array('default' => ''))
              ->addColumn('actiontime', 'integer', array('default' => 0))
              ->addColumn('begin_waiting_date', 'datetime', array('default' => null, 'null' => true))
      ...
      $problem_supplier->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('supplier_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('type', 'integer', array('default' => 1))
                       ->addColumn('use_notification', 'boolean', array('default' => false))
                       ->addColumn('alternative_email', 'string', array('null' => true, 'default' => null))
                       ->addForeignKey('problem_id', 'glpi_problem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addForeignKey('supplier_id', 'glpi_supplier', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $problem_ticket->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                     ->addForeignKey('problem_id', 'glpi_problem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $problem_user->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('type', 'integer', array('default' => 1))
                   ->addColumn('use_notification', 'boolean', array('default' => false))
                   ->addColumn('alternative_email', 'string', array('null' => true, 'default' => null))
      ...
      $problemcost->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('begin_date', 'date', array('null' => true, 'default' => null))
                  ->addColumn('end_date', 'date', array('null' => true, 'default' => null))
                  ->addColumn('actiontime', 'integer', array('default' => 0))
                  ->addColumn('cost_time', 'decimal', array('precision' => 20, 'scale' => 4, 'null' => true, 'default' => '0.0000'))
      ...
      $problemtask->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('taskcategory_id', 'integer', array('default' => null, 'null' => true))
      ...
      $group_user->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('is_dynamic', 'boolean', array('default' => false))
      ...
      $group_ticket->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('type', 'integer', array('default' => 1))
                   ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('group_id', 'glpi_group', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $group_rssfeed->addColumn('rssfeed_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('entity_id', 'integer')
                    ->addColumn('is_recursive', 'boolean', array('default' => false))
                    ->addForeignKey('rssfeed_id', 'glpi_rssfeed', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $group_problem->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('type', 'integer', array('default' => 1))
                    ->addForeignKey('problem_id', 'glpi_problem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('group_id', 'glpi_group', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $entity_rssfeed->addColumn('rssfeed_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('entity_id', 'integer')
                     ->addColumn('is_recursive', 'boolean', array('default' => false))
                     ->addForeignKey('rssfeed_id', 'glpi_rssfeed', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $computer_softwarelicense->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
                               ->addColumn('softwarelicense_id', 'integer', array('default' => null, 'null' => true))
                               ->addColumn('is_deleted', 'boolean', array('default' => false))
                               ->addColumn('is_dynamic', 'boolean', array('default' => false))
                               ->addForeignKey('computer_id', 'glpi_computer', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                               ->addForeignKey('softwarelicense_id', 'glpi_softwarelicense', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $computer_softwareversion->addColumn('computer_id', 'integer', array('default' => null, 'null' => true))
                               ->addColumn('softwareversion_id', 'integer', array('default' => null, 'null' => true))
                               ...
                               ->addForeignKey('computer_id', 'glpi_computer', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                               ->addForeignKey('softwareversion_id', 'glpi_softwareversion', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $knowbaseitem->addColumn('name', 'string', array('null' => true))
                   ->addColumn('knowbaseitemcategory_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('answer', 'text', array('default' => ''))
      ...
      $entity_knowbaseitem->addColumn('knowbaseitem_id', 'integer', array('default' => 0))
                          ->addColumn('entity_id', 'integer', array('default' => 0))
                          ->addColumn('is_recursive', 'boolean', array('default' => false))
                          ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                          ->addForeignKey('knowbaseitem_id', 'glpi_knowbaseitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $group_knowbaseitem->addColumn('knowbaseitem_id', 'integer', array('default' => null, 'null' => true))
                         ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                         ->addColumn('entity_id', 'integer')
                         ->addColumn('is_recursive', 'boolean', array('default' => false))
                         ->addForeignKey('knowbaseitem_id', 'glpi_knowbaseitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $knowbaseitem_profile->addColumn('knowbaseitem_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('profile_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('entity_id', 'integer')
                           ->addColumn('is_recursive', 'boolean', array('default' => false))
                           ->addForeignKey('knowbaseitem_id', 'glpi_knowbaseitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $knowbaseitem_user->addColumn('knowbaseitem_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                        ->addForeignKey('knowbaseitem_id', 'glpi_knowbaseitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addIndex(array('knowbaseitem_id'))
      ...
      $profile_reminder->addColumn('reminder_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('profile_id', 'integer', array('default' => null, 'null' => true))
...
//                       ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $profile_rssfeed->addColumn('rssfeed_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('profile_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('entity_id', 'integer', array('default' => -1))
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ->addForeignKey('rssfeed_id', 'glpi_rssfeed', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
...
//                      ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $infocom->addColumn('itemtype', 'string', array('limit' => 100))
              ...
              ->addColumn('warranty_info', 'string', array('null' => true, 'default' => null))
              ->addColumn('supplier_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('order_number', 'string', array('null' => true, 'default' => null))
              ->addColumn('delivery_number', 'string', array('null' => true, 'default' => null))
              ->addColumn('immo_number', 'string', array('null' => true, 'default' => null))
              ->addColumn('value', 'decimal', array('precision' => 20, 'scale' => 4, 'null' => true, 'default' => '0.0000'))
              ...
              ->addColumn('bill', 'string', array('null' => true, 'default' => null))
              ->addColumn('budget_id', 'integer', array('default' => null, 'null' => true))
              ->addColumn('alert', 'integer', array('default' => 0))
      ...
      $change->addColumn('name', 'string', array('null' => true))
             ->addColumn('entity_id', 'integer')
             ->addColumn('is_recursive', 'boolean', array('default' => false))
             ->addColumn('is_deleted', 'boolean', array('default' => false))
             ->addColumn('status', 'integer', array('default' => 1))
             ...
             ->addColumn('itilcategory_id', 'integer', array('default' => null, 'null' => true))
             ->addColumn('impactcontent', 'text', array('default' => ''))
             ->addColumn('controlistcontent', 'text', array('default' => ''))
             ->addColumn('rolloutplancontent', 'text', array('default' => ''))
             ->addColumn('backoutplancontent', 'text', array('default' => ''))
             ->addColumn('checklistcontent', 'text', array('default' => ''))
             ->addColumn('global_validation', 'integer', array('default' => 1))
      ...
      $change_group = $this->table('change_group');
      $change_group->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('group_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('type', 'integer', array('default' => 1))
                   ->addForeignKey('change_id', 'glpi_change', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('group_id', 'glpi_group', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $changecost->addColumn('name', 'string', array('null' => true))
                 ->addColumn('entity_id', 'integer')
                 ->addColumn('is_recursive', 'boolean', array('default' => false))
                 ->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('begin_date', 'date', array('null' => true, 'default' => null))
                 ->addColumn('end_date', 'date', array('null' => true, 'default' => null))
                 ->addColumn('actiontime', 'integer', array('default' => 0))
                 ->addColumn('cost_time', 'decimal', array('precision' => 20, 'scale' => 4, 'null' => true, 'default' => '0.0000'))
      ...
      $change_problem->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                     ->addForeignKey('change_id', 'glpi_change', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('problem_id', 'glpi_problem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $change_project->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('project_id', 'integer', array('default' => null, 'null' => true))
                     ->addForeignKey('change_id', 'glpi_change', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('project_id', 'glpi_project', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $change_supplier->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('supplier_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('type', 'integer', array('default' => 1))
                      ->addColumn('use_notification', 'boolean', array('default' => false))
                      ->addColumn('alternative_email', 'string', array('null' => true, 'default' => null))
      ...
      $change_ticket->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                    ->addForeignKey('change_id', 'glpi_change', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $change_user->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('type', 'integer', array('default' => 1))
                  ->addColumn('use_notification', 'boolean', array('default' => false))
                  ->addColumn('alternative_email', 'string', array('null' => true, 'default' => null))
      ...
      $change_item->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('itemtype', 'string', array('limit' => 100))
                  ->addColumn('items_id', 'integer', array('default' => 0))
                  ->addForeignKey('change_id', 'glpi_change', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $changetask->addColumn('change_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('taskcategory_id', 'integer', array('default' => null, 'null' => true))
                 ->addColumn('state', 'integer', array('default' => 0))
                 ->addColumn('date', 'datetime', array('null' => true, 'default' => null))
                 ->addColumn('begin_date', 'datetime', array('null' => true, 'default' => null))
      ...
      $document->addColumn('name', 'string', array('null' => true))
               ->addColumn('entity_id', 'integer')
               ->addColumn('is_recursive', 'boolean', array('default' => false))
               ->addColumn('filename', 'string', array('null' => true, 'default' => null, 'comment' => 'for display and transfert'))
               ->addColumn('filepath', 'string', array('null' => true, 'default' => null, 'comment' => 'file storage path'))
               ->addColumn('documentcategory_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('mime', 'string', array('null' => true, 'default' => null))
               ->addColumn('is_deleted', 'boolean', array('default' => false))
               ->addColumn('link', 'integer', array('default' => null, 'null' => true))
               ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
               ->addColumn('sha1sum', 'char', array('limit' => 40, 'null' => true, 'default' => null))
               ->addColumn('is_blacklisted', 'boolean', array('default' => false))
               ->addColumn('tag', 'string', array('null' => true, 'default' => null))
               ->addColumn('comment', 'text', array('default' => ''))
               ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
               ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
               ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $document_item->addColumn('document_id', 'integer', array('default' => null, 'null' => true))
                    ->addColumn('itemtype', 'string', array('limit' => 100))
                    ->addColumn('items_id', 'integer', array('default' => 0))
                    ->addColumn('entity_id', 'integer')
                    ->addColumn('is_recursive', 'boolean', array('default' => false))
                    ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                    ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                    ->addForeignKey('document_id', 'glpi_document', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                    ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $ipaddress_ipnetwork->addColumn('ipaddress_id', 'integer', array('default' => null, 'null' => true))
                          ->addColumn('ipnetwork_id', 'integer', array('default' => null, 'null' => true))
                          ->addForeignKey('ipaddress_id', 'glpi_ipaddress', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                          ->addForeignKey('ipnetwork_id', 'glpi_ipnetwork', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $ipnetwork_vlan->addColumn('ipnetwork_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('vlan_id', 'integer', array('default' => null, 'null' => true))
                     ->addForeignKey('ipnetwork_id', 'glpi_ipnetwork', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('vlan_id', 'glpi_vlan', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $item_devicecase->addColumn('devicecase_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('itemtype', 'string', array('limit' => 100))
                      ->addColumn('items_id', 'integer', array('default' => 0))
                      ->addColumn('entity_id', 'integer')
                      ->addColumn('is_recursive', 'boolean', array('default' => false))
                      ...
                      ->addColumn('is_dynamic', 'boolean', array('default' => false))
                      ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                      ->addForeignKey('devicecase_id', 'glpi_devicecase', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                      ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                      ->addIndex(array('items_id'))
      ...
      $item_devicecontrol->addColumn('devicecontrol_id', 'integer', array('default' => null, 'null' => true))
                         ->addColumn('itemtype', 'string', array('limit' => 100))
                         ->addColumn('items_id', 'integer', array('default' => 0))
                         ->addColumn('entity_id', 'integer')
                         ->addColumn('is_recursive', 'boolean', array('default' => false))
                         ...
                         ->addColumn('is_dynamic', 'boolean', array('default' => false))
                         ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                         ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                         ->addForeignKey('devicecontrol_id', 'glpi_devicecontrol', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                         ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                         ->addIndex(array('items_id'))
      ...
      $item_devicedrive->addColumn('devicedrive_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('itemtype', 'string', array('limit' => 100))
                       ->addColumn('items_id', 'integer', array('default' => 0))
                       ->addColumn('entity_id', 'integer')
                       ->addColumn('is_recursive', 'boolean', array('default' => false))
                       ...
                       ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                       ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                       ->addForeignKey('devicedrive_id', 'glpi_devicedrive', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                       ->addIndex(array('items_id'))
      ...
      $item_devicegraphiccard->addColumn('devicegraphiccard_id', 'integer', array('default' => null, 'null' => true))
                             ->addColumn('itemtype', 'string', array('limit' => 100))
                             ->addColumn('items_id', 'integer', array('default' => 0))
                             ->addColumn('entity_id', 'integer')
                             ->addColumn('is_recursive', 'boolean', array('default' => false))
                             ...
                             ->addForeignKey('devicegraphiccard_id', 'glpi_devicegraphiccard', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                             ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                             ->addIndex(array('items_id'))
      ...
      $item_deviceharddrive->addColumn('deviceharddrive_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('itemtype', 'string', array('limit' => 100))
                           ->addColumn('items_id', 'integer', array('default' => 0))
                           ->addColumn('entity_id', 'integer')
                           ->addColumn('is_recursive', 'boolean', array('default' => false))
                           ...
                           ->addForeignKey('deviceharddrive_id', 'glpi_deviceharddrive', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                           ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                           ->addIndex(array('items_id'))
      ...
      $item_devicememory->addColumn('devicememory_id', 'integer', array('default' => null, 'null' => true))
                        ->addColumn('itemtype', 'string', array('limit' => 100))
                        ->addColumn('items_id', 'integer', array('default' => 0))
                        ->addColumn('entity_id', 'integer')
                        ->addColumn('is_recursive', 'boolean', array('default' => false))
                        ...
                        ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                        ->addColumn('size', 'integer', array('default' => 0))
                        ->addForeignKey('devicememory_id', 'glpi_devicememory', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                        ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                        ->addIndex(array('items_id'))
      ...
      $item_devicemotherboard->addColumn('devicemotherboard_id', 'integer', array('default' => null, 'null' => true))
                             ->addColumn('itemtype', 'string', array('limit' => 100))
                             ->addColumn('items_id', 'integer', array('default' => 0))
                             ->addColumn('entity_id', 'integer')
                             ->addColumn('is_recursive', 'boolean', array('default' => false))
                             ...
                             ->addColumn('is_dynamic', 'boolean', array('default' => false))
                             ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                             ->addForeignKey('devicemotherboard_id', 'glpi_devicemotherboard', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                             ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                             ->addIndex(array('items_id'))
      ...
      $item_devicenetworkcard->addColumn('devicenetworkcard_id', 'integer', array('default' => null, 'null' => true))
                             ->addColumn('itemtype', 'string', array('limit' => 100))
                             ->addColumn('items_id', 'integer', array('default' => 0))
                             ->addColumn('entity_id', 'integer')
                             ->addColumn('is_recursive', 'boolean', array('default' => false))
                             ...
                             ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                             ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                             ->addColumn('mac', 'string', array('null' => true, 'default' => null))
                             ->addForeignKey('devicenetworkcard_id', 'glpi_devicenetworkcard', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                             ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                             ->addIndex(array('items_id'))
      ...
      $item_devicepci->addColumn('devicepci_id', 'integer', array('default' => null, 'null' => true))
                     ->addColumn('itemtype', 'string', array('limit' => 100))
                     ->addColumn('items_id', 'integer', array('default' => 0))
                     ->addColumn('entity_id', 'integer')
                     ->addColumn('is_recursive', 'boolean', array('default' => false))
                     ...
                     ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                     ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                     ->addForeignKey('devicepci_id', 'glpi_devicepci', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                     ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                     ->addIndex(array('items_id'))
      ...
      $item_devicepowersupply->addColumn('devicepowersupply_id', 'integer', array('default' => null, 'null' => true))
                             ->addColumn('itemtype', 'string', array('limit' => 100))
                             ->addColumn('items_id', 'integer', array('default' => 0))
                             ->addColumn('entity_id', 'integer')
                             ->addColumn('is_recursive', 'boolean', array('default' => false))
                             ...
                             ->addColumn('is_dynamic', 'boolean', array('default' => false))
                             ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                             ->addForeignKey('devicepowersupply_id', 'glpi_devicepowersupply', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                             ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                             ->addIndex(array('items_id'))
      ...
      $item_deviceprocessor->addColumn('deviceprocessor_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('itemtype', 'string', array('limit' => 100))
                           ->addColumn('items_id', 'integer', array('default' => 0))
                           ->addColumn('entity_id', 'integer')
                           ->addColumn('is_recursive', 'boolean', array('default' => false))
                           ...
                           ->addColumn('nbcores', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('nbthreads', 'integer', array('default' => null, 'null' => true))
                           ->addForeignKey('deviceprocessor_id', 'glpi_deviceprocessor', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                           ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                           ->addIndex(array('items_id'))
      ...
      $item_devicesoundcard->addColumn('devicesoundcard_id', 'integer', array('default' => null, 'null' => true))
                           ->addColumn('itemtype', 'string', array('limit' => 100))
                           ->addColumn('items_id', 'integer', array('default' => 0))
                           ->addColumn('entity_id', 'integer')
                           ->addColumn('is_recursive', 'boolean', array('default' => false))
                           ...
                           ->addColumn('serial', 'string', array('null' => true, 'default' => null))
                           ->addColumn('busid', 'string', array('null' => true, 'default' => null))
                           ->addForeignKey('devicesoundcard_id', 'glpi_devicesoundcard', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                           ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                           ->addIndex(array('items_id'))
      ...
      $item_problem->addColumn('problem_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('itemtype', 'string', array('limit' => 100))
                   ->addColumn('items_id', 'integer', array('default' => 0))
                   ->addForeignKey('problem_id', 'glpi_problem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $item_project->addColumn('project_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('itemtype', 'string', array('limit' => 100))
                   ->addColumn('items_id', 'integer', array('default' => 0))
                   ->addForeignKey('project_id', 'glpi_project', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $item_ticket->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('itemtype', 'string', array('limit' => 100))
                  ->addColumn('items_id', 'integer', array('default' => 0))
                  ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $knowbaseitemtranslation->addColumn('knowbaseitem_id', 'integer', array('default' => null, 'null' => true))
                              ->addColumn('language', 'string', array('limit' => 5, 'null' => true))
                              ->addColumn('name', 'text', array('default' => ''))
                              ->addColumn('answer', 'text', array('default' => ''))
                              ->addForeignKey('knowbaseitem_id', 'glpi_knowbaseitem', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $networkalias->addColumn('name', 'string', array('null' => true))
                   ->addColumn('entity_id', 'integer')
                   ->addColumn('networkname_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('fqdn_id', 'integer', array('default' => null, 'null' => true))
                   ->addColumn('comment', 'text', array('default' => ''))
                   ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                   ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                   ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('networkname_id', 'glpi_networkname', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addForeignKey('fqdn_id', 'glpi_fqdn', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                   ->addIndex(array('name'))
                   ->addIndex(array('entity_id'))
      ...
      $networkequipment->addColumn('name', 'string', array('null' => true))
                       ->addColumn('entity_id', 'integer')
                       ->addColumn('is_recursive', 'boolean', array('default' => false))
                       ->addColumn('serial', 'string', array('null' => true))
                       ->addColumn('otherserial', 'string', array('null' => true))
                       ...
                       ->addColumn('state_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('ticket_tco', 'decimal', array('precision' => 20, 'scale' => 4, 'null' => true, 'default' => '0.0000'))
                       ->addColumn('ram', 'string', array('null' => true, 'default' => null))
                       ->addColumn('comment', 'text', array('default' => ''))
                       ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                       ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                       ->addForeignKey('entity_id', 'glpi_entity', 'id', array('delete'=> 'CASCADE', 'update'=> 'NO_ACTION'))
      ...
      $networkportethernet->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
      ...
      $networkportfiberchannel->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                              ->addColumn('item_devicenetworkcard_id', 'integer', array('default' => null, 'null' => true))
                              ->addColumn('netpoint_id', 'integer', array('default' => null, 'null' => true))
      ...
      $networkport_vlan->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                       ->addColumn('vlan_id', 'integer', array('default' => null, 'null' => true))
      ...
      $networkportwifi->addColumn('networkport_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('item_devicenetworkcard_id', 'integer', array('default' => null, 'null' => true))
                      ...
                      ->addColumn('version', 'string', array('limit' => 20, 'null' => true, 'default' => null, 'comment' => 'a, a/b, a/b/g, a/b/g/n, a/b/g/n/y'))
                      ->addColumn('mode', 'string', array('limit' => 20, 'null' => true, 'default' => null, 'comment' => 'ad-hoc, managed, master, repeater, secondary, monitor, auto'))
                      ->addColumn('date_mod', 'datetime', array('null' => true, 'default' => null))
                      ->addColumn('date_creation', 'datetime', array('default' => 'CURRENT_TIMESTAMP'))
                      ->addForeignKey('networkport_id', 'glpi_networkport', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                      ->addForeignKey('item_devicenetworkcard_id', 'glpi_item_devicenetworkcard', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $notimportedemail->addColumn('from', 'string')
                       ...
                       ->addColumn('date', 'datetime')
                       ->addColumn('subject', 'text', array('default' => ''))
                       ->addColumn('messageid', 'string')
                       ->addColumn('reason', 'integer', array('default' => 0))
                       ->addColumn('user_id', 'integer', array('default' => null, 'null' => true))
                       ->addForeignKey('mailcollector_id', 'glpi_mailcollector', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addForeignKey('user_id', 'glpi_user', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                       ->addIndex(array('user_id'))
      ...
      $peripheral->addColumn('name', 'string', array('null' => true))
                  ->addColumn('entity_id', 'integer')
                  ->addColumn('is_recursive', 'boolean', array('default' => false))
                  ->addColumn('serial', 'string', array('null' => true))
                  ->addColumn('otherserial', 'string', array('null' => true))
      ...
      $projecttask_ticket->addColumn('ticket_id', 'integer', array('default' => null, 'null' => true))
                         ->addColumn('projecttask_id', 'integer', array('default' => null, 'null' => true))
                         ->addForeignKey('ticket_id', 'glpi_ticket', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                         ->addForeignKey('projecttask_id', 'glpi_projecttask', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
      ...
      $projectteam->addColumn('project_id', 'integer', array('default' => null, 'null' => true))
                  ->addColumn('itemtype', 'string', array('limit' => 100))
                  ->addColumn('items_id', 'integer', array('default' => 0))
                  ->addForeignKey('project_id', 'glpi_project', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
                  ->addIndex(array('project_id', 'itemtype', 'items_id'), array('unique' => true))
      ...
      $projecttaskteam->addColumn('projecttask_id', 'integer', array('default' => null, 'null' => true))
                      ->addColumn('itemtype', 'string', array('limit' => 100))
                      ->addColumn('items_id', 'integer', array('default' => 0))
                      ->addForeignKey('projecttask_id', 'glpi_projecttask', 'id', array('delete'=> 'SET_NULL', 'update'=> 'NO_ACTION'))
